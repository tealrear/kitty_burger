...
def generate_launch_description():
    return LaunchDescription([
        ...
        Node(package='sdr_brain_system', executable='mission_controller', name='mission_controller'),
        Node(package='sdr_brain_system', executable='digit_reader', name='digit_reader'),
