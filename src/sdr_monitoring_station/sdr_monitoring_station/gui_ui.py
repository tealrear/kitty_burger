...
"")
        ...
        self.face_label = QLabel(self.page_0)
        self.face_label.setObjectName(u"face_label")
        self.face_label.setGeometry(QRect(90, 50, 551, 331))
    ...
    def retranslateUi(self, Form):
        ...
        self.face_label.setText(QCoreApplication.translate("Form", u"face_label", None))
