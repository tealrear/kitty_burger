...
"}\n"
"\n"
"QWidget#page_0,QWidget#page_1, QWidget#page_2, QWidget#page_3 {\n"
...
"}\n"
"\n"
"QLabel#label_page_0, QLabel#label_page_1, QLabel#label_page_2, QLabel#label_page_3 {\n"
"    color: #8ffcff;\n"
"    font-size: 18pt;\n"
"    font-weight: bold;\n"
"}\n"
...
"}\n"
"\n"
"QGroupBox#groupBox_page_0,\n"
"QGroupBox#groupBox_page_1,\n"
...
"")
        ...
        self.groupBox_page_0 = QGroupBox(self.page_0)
        self.groupBox_page_0.setObjectName(u"groupBox_page_0")
        self.groupBox_page_0.setGeometry(QRect(230, 440, 320, 58))
        self.label_page_0 = QLabel(self.groupBox_page_0)
        self.label_page_0.setObjectName(u"label_page_0")
        self.label_page_0.setGeometry(QRect(110, 7, 100, 42))
        self.label_page_0.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.btn_pre_0 = QPushButton(self.groupBox_page_0)
        self.btn_pre_0.setObjectName(u"btn_pre_0")
        self.btn_pre_0.setGeometry(QRect(10, 8, 95, 40))
        self.btn_next_0 = QPushButton(self.groupBox_page_0)
        self.btn_next_0.setObjectName(u"btn_next_0")
        self.btn_next_0.setGeometry(QRect(215, 8, 95, 40))
        self.face_widget = QWidget(self.page_0)
        self.face_widget.setObjectName(u"face_widget")
        self.face_widget.setGeometry(QRect(60, 30, 681, 401))
        self.face_widget.setStyleSheet(u"background-color: #000000;\n"
"border: none;")
        self.stackedWidget.addWidget(self.page_0)
        self.page_1 = QWidget()
        self.page_1.setObjectName(u"page_1")
        self.Face_listWidget = QListWidget(self.page_1)
        self.Face_listWidget.setObjectName(u"Face_listWidget")
        self.Face_listWidget.setGeometry(QRect(540, 180, 221, 261))
        self.battery_label = QLabel(self.page_1)
        ...
        self.groupBox_page_1 = QGroupBox(self.page_1)
        self.groupBox_page_1.setObjectName(u"groupBox_page_1")
        self.groupBox_page_1.setGeometry(QRect(205, 440, 320, 58))
        self.label_page_1 = QLabel(self.groupBox_page_1)
        self.label_page_1.setObjectName(u"label_page_1")
        self.label_page_1.setGeometry(QRect(110, 7, 100, 42))
        self.label_page_1.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.btn_pre_1 = QPushButton(self.groupBox_page_1)
        self.btn_pre_1.setObjectName(u"btn_pre_1")
        self.btn_pre_1.setGeometry(QRect(10, 8, 95, 40))
        self.btn_next_1 = QPushButton(self.groupBox_page_1)
        self.btn_next_1.setObjectName(u"btn_next_1")
        self.btn_next_1.setGeometry(QRect(215, 8, 95, 40))
        self.groupBox_face = QGroupBox(self.page_1)
        ...
        self.camera_label = QLabel(self.page_1)
        self.camera_label.setObjectName(u"camera_label")
        self.camera_label.setGeometry(QRect(80, 30, 401, 391))
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox_page_0.setTitle("")
        self.label_page_0.setText(QCoreApplication.translate("Form", u"0page", None))
        self.btn_pre_0.setText(QCoreApplication.translate("Form", u"PREV", None))
        self.btn_next_0.setText(QCoreApplication.translate("Form", u"NEXT", None))
        self.battery_label.setText(QCoreApplication.translate("Form", u"\ubc30\ud130\ub9ac \uc794\ub7c9 :", None))
        self.groupBox_page_1.setTitle("")
        self.label_page_1.setText(QCoreApplication.translate("Form", u"1page", None))
        self.btn_pre_1.setText(QCoreApplication.translate("Form", u"PREV", None))
        self.btn_next_1.setText(QCoreApplication.translate("Form", u"NEXT", None))
        self.groupBox_face.setTitle("")
        self.Face_lineEdit.setText("")
        self.btn_face.setText(QCoreApplication.translate("Form", u"\ud655\uc778", None))
        self.camera_label.setText(QCoreApplication.translate("Form", u"camera_label", None))
